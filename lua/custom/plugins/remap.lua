...
return {
  ...
  vim.keymap.set('n', '<leader>tt', ':Neotree position=left source=filesystem action=show toggle=true<CR>', { desc = 'Toggle neotree' }),
  vim.keymap.set('n', '<leader>tf', ':Neotree position=left source=filesystem action=focus toggle=false<CR>', { desc = 'Toggle and focus neotree' }),
